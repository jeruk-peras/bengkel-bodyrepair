...
class UsersModel extends Model
{
    ...
    protected $validationRules      = [
        ...
        'alamat'           => 'required',
        'username'         => 'required|max_length[100]|is_unique[users.username,id_user,{id_user}]|is_unique[admin_cabang.username]',
    ...
    protected $validationMessages   = [
        ...
        'role' => [
            ...
            'in_list'  => 'Role harus salah satu dari: Super Admin, Admin.',
        ],
    ];
