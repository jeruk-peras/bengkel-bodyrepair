<script>
    ...
    var table = $('#datatable').DataTable({
        ...
        ajax: {
            url: '/datatable-server-side/mekanik', // URL file untuk proses select datanya
            type: 'POST',
            data: {
        ...
        columnDefs: [{
            ...
            render: function(data, type, row, meta) {
                var btn =
                    '<a href="/mekanik/' + data + '/edit" class="me-2 btn btn-sm btn-primary btn-edit" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit Data"><i class="bx bx-pencil me-0"></i></a>' +
                    '<a href="/mekanik/' + data + '/delete" class="me-2 btn btn-sm btn-danger btn-delete" data-id-produk="' + data + '" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Hapus Data"><i class="bx bx-trash me-0"></i></a>'
                return btn;
            }
