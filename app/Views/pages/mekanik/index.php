        ...
        <div class="modal-content">
            ...
            <form action="" method="post" id="form-data">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="nama_mekanik" class="form-label required">Nama Mekanik</label>
                            <input type="text" name="nama_mekanik" class="form-control" id="nama_mekanik" placeholder="Nama Mekanik">
                            <div class="invalid-feedback" id="invalid_nama_mekanik"></div>
                        </div>
                        <div class="col-md-6">
                            <label for="no_handphone" class="form-label required">No Handpone</label>
                            <input type="text" name="no_handphone" class="form-control" id="no_handphone" placeholder="No Handpone">
...
<?= $this->include('pages/mekanik/script'); ?>
<?= $this->endSection(); ?>
