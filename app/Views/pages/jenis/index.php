        ...
        <div class="modal-content">
            ...
            <form action="" method="post" id="form-data">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-12">
                            <label for="nama_jenis" class="form-label required">Nama Jenis</label>
                            <input type="text" name="nama_jenis" class="form-control" id="nama_jenis" placeholder="Nama Jenis">
                            <div class="invalid-feedback" id="invalid_nama_jenis"></div>
                        </div>
                    </div>
                </div>
...
<?= $this->include('pages/jenis/script'); ?>
<?= $this->endSection(); ?>
