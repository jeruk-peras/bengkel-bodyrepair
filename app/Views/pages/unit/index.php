...
<div class="page-content">
    ...
    <div class="card radius-10">
        <div class="card-header border-0 bg-transparent overflow-x-auto">
            <div class="d-flex align-items-center" style="white-space: nowrap;">
                ...
                <div class="ms-auto">
                    <ul class="nav nav-pills flex-nowrap" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link px-5 py-1" data-bs-toggle="pill" href="#daftar-status-unit" id="tab-status-unit" role="tab" aria-selected="false" tabindex="-1">
                                <div class="d-flex align-items-center">
                                    <div class="tab-title">Daftar Status Unit</div>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="/unit/add" class="btn btn-sm btn-primary px-4"><i class="bx bx-plus"></i> Tambah</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="card-body">
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="daftar-status-unit" role="tabpanel">
                    <div class="table-responsive" id="data-status-unit"></div>
                </div>
            </div>
        </div>
    </div>
