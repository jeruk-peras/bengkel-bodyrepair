    ...
    var table = $('#datatable').DataTable({
        ...
        columnDefs: [{
            ...
            render: function(data, type, row, meta) {
                var btn =
                    '<a href="/unit/' + data + '/edit" class="me-2 btn btn-sm btn-primary btn-edit"><i class="bx bx-pencil me-0"></i></a>' +
                    '<a href="/unit/' + data + '/detail" data-id="' + data + '" class="me-2 btn btn-sm btn-primary btn-detail"><i class="bx bx-info-circle me-0"></i></a>' +
                    '<a href="/unit/' + data + '/delete" class="me-2 btn btn-sm btn-danger btn-delete"><i class="bx bx-trash me-0"></i></a>'
                return btn;
            }
        }, ],
        pageLength: 25,
