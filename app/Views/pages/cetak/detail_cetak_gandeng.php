...
<div class="page-content">
        ...
        <div class="ps-1">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active">Cetak Foto Gandeng</li>
                    <li class="breadcrumb-item active" aria-current="page">Add Foto Gandeng</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="row mb-3">
        <div class="col-8 col-sm-8 col-md-6 col-lg-12 text-end">
            <a href="<?= base_url('cetak/gandeng'); ?>" class="btn btn-sm btn-primary"><i class="bx bx-left-arrow-alt"></i> Kembali</a>
    ...
    <div id="print-data" class="m-3">
        ...
        <h2 class="fw-bolder text-black">FOTO GANDENG</h2>
