    ...
    var table = $('#datatable').DataTable({
        ...
        columnDefs: [{
            ...
            render: function(data, type, row, meta) {
                var btn =
                    '<a href="/cabang/' + data + '/edit" class="me-2 btn btn-sm btn-primary btn-edit"><i class="bx bx-pencil me-0"></i></a>' +
                    '<a href="/cabang/' + data + '/delete" class="me-2 btn btn-sm btn-danger btn-delete" data-id-produk="' + data + '"><i class="bx bx-trash me-0"></i></a>'
                return btn;
            }
        }, ],
        pageLength: 25,
