        ...
        <div class="ps-1">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Daftar Admin Cabang</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="card radius-10">
        <div class="card-header border-0 bg-transparent">
            <div class="d-flex align-items-center">
                <div>
                    <h6 class="mb-0">Daftar Admin Cabang</h6>
                </div>
                <div class="ms-auto">
                ...
                <div class="modal-body">
                    <div class="row g-3 mb-3" id="field-data">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="cabang_id" class="form-control" id="cabang_id"></select>
...
<?= $this->include('pages/admin/script'); ?>
<?= $this->endSection(); ?>