<script>
    ...
    table.on('click', 'tbody tr td button.btn-add-material', function(e) {
        ...
        $('#form-add-material').attr('action', '/material-keluar/' + id + '/add');
    ...
    function fetchDataMaterial(filter, search = null) {
        $.ajax({
            url: '/datatable-server-side/' + filter + '/data-material-keluar?search=' + (search ? encodeURIComponent(search) : ''),
            type: 'GET',
            dataType: 'json',
            success: function(response) {
