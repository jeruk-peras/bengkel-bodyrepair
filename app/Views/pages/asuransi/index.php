        ...
        <div class="ps-1">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Daftar Asuransi</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="card radius-10">
        <div class="card-header border-0 bg-transparent">
            <div class="d-flex align-items-center">
                <div>
                    <h6 class="mb-0">Daftar Asuransi</h6>
                </div>
                <div class="ms-auto">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="nama_asuransi" class="form-control" id="nama_asuransi" placeholder="Nama Asuransi">
                            <div class="invalid-feedback" id="invalid_nama_asuransi"></div>
                        </div>
                    </div>
                </div>
...
<?= $this->include('pages/asuransi/script'); ?>
<?= $this->endSection(); ?>
